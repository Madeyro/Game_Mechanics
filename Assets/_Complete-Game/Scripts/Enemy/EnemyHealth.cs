...
namespace CompleteProject
{
    ...
    {
        static public List<EnemyMovement> enemies = new List<EnemyMovement>();
        const float alertRange = 7.5f;
        ...
        public void TakeDamage(int amount, Vector3 hitPoint, GameObject sender)
        {
            ...
            if (sender.name == "Sentry")
            {
                AlertNearbyToSentry();
            }
        }

        void AlertNearbyToSentry()
        {
